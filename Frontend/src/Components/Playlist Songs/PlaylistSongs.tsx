...
const PlaylistSongs = ({playlistPlay, removeFromPlaylist, addToPlaylist, addToQueue, item, index, dropdown, toggleDropdown}:{playlistPlay:Function, removeFromPlaylist:Function, addToPlaylist:Function, addToQueue:Function, item:Song, index:number, dropdown: number | null, toggleDropdown: Function}) => {
